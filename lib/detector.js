...
class Detector {
    ...
    saveTarget(data, options) {
        ...
        return new Promise((resolve, reject) => {
            ...
            if (
                Object.prototype.hasOwnProperty.call(opts, 'withRelated') &&
            ...
            return result
                .save(saveValue, _.pick(opts, ['transacting', 'method'].concat(allowedOptions)))
                .then((result) => {
                    return result;
                });
        });
    ...
    getExistingTargets(data, options) {
        ...
        return new Promise((resolve, reject) => {
            ...
            return existingRelations
                .fetch(_.pick(opts, ['transacting', 'method'].concat(allowedOptions)))
    ...
    getMatchingTarget(data, options) {
        ...
        if (existingTargets && existingTargets.relatedData.type === 'belongsToMany') {
            if (
                Object.prototype.hasOwnProperty.call(
                    properties,
                    existingTargets.relatedData.otherKey,
                )
            ) {
            ...
            if (
                ...
                Object.prototype.hasOwnProperty.call(
                    properties,
                    existingTargets.relatedData.foreignKey,
                )
            ) {
                if (!Object.prototype.hasOwnProperty.call(properties, 'id')) {
        ...
        return Target.forge(properties)
            .fetch(_.pick(opts, ['transacting']))
            .then((matching) => {
    ...
    saveTargets(data, options) {
        ...
        return Promise.each(newTargets, (properties) => {
            ...
            return new Promise((resolve, reject) => {
                ...
                return result
                    .save(null, _.pick(opts, ['transacting', 'method'].concat(allowedOptions)))
                    .then((result) => {
                        results.push(result);
                    });
            });
