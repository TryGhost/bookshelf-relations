            ...
            return testUtils.testPostModel({
                ...
                expectSuccess: (result) => {
                    ...
                    result
                        ...
                        .models[0].id.should.eql(
                            testUtils.fixtures.getAll().posts[1].custom_fields[0].id,
                        );
                    result
                        .related('custom_fields')
                        .models[0].get('key')
                        .should.eql(testUtils.fixtures.getAll().posts[1].custom_fields[0].key);
                    result
                        .related('custom_fields')
                        .models[0].get('value')
                        .should.eql('this-time-different');
                    ...
                    return testUtils.database
                        ...
                        .then((result) => {
                            ...
                            result[0].key.should.eql(
                                testUtils.fixtures.getAll().posts[1].custom_fields[0].key,
                            );
                ...
                expectError: (result) => {
                    ...
                    return testUtils.database
                        ...
                        .then((result) => {
                            ...
                            result[0].value.should.eql(
                                testUtils.fixtures.getAll().posts[1].custom_fields[0].value,
                            );

                            result[1].id.should.eql(
                                testUtils.fixtures.getAll().posts[1].custom_fields[1].id,
                            );
                            result[1].key.should.eql(
                                testUtils.fixtures.getAll().posts[1].custom_fields[1].key,
                            );
                            result[1].value.should.eql(
                                testUtils.fixtures.getAll().posts[1].custom_fields[1].value,
                            );
                        });
                },
            });
                ...
                expectSuccess: (outerResult) => {
                    ...
                    return testUtils.database
                        ...
                        .then((result) => {
                            ...
                            result[2].id.should.eql(
                                outerResult.related('custom_fields').models[0].id,
                            );
                            result[2].key.should.eql(
                                testUtils.fixtures.getAll().posts[1].custom_fields[0].key,
                            );
